...
import com.yiayoframework.base.common.YiayoStringUtils;
...
public class ReadWriteDataSourceBuilder {
    ...
    private static DruidDataSource createDataSource(Properties properties, String prefix, String url, String username, String password) throws SQLException {
        ...
        dataSource.setInitialSize(YiayoStringUtils.parseInt(properties.getProperty(prefix + ".jdbc.initialSize"), 1));
        dataSource.setMaxActive(YiayoStringUtils.parseInt(properties.getProperty(prefix + ".jdbc.maxActive"), 80));
        dataSource.setMinIdle(YiayoStringUtils.parseInt(properties.getProperty(prefix + ".jdbc.minIdle"), 10));
        dataSource.setMaxWait(YiayoStringUtils.parseInt(properties.getProperty(prefix + ".jdbc.maxWait"), 60000));
        ...
        dataSource.setTimeBetweenEvictionRunsMillis(YiayoStringUtils.parseInt(properties.getProperty(prefix + ".jdbc.timeBetweenEvictionRunsMillis"), 60000));
        dataSource.setMinEvictableIdleTimeMillis(YiayoStringUtils.parseInt(properties.getProperty(prefix + ".jdbc.minEvictableIdleTimeMillis"), 25200000));
        dataSource.setRemoveAbandoned(Boolean.valueOf(properties.getProperty(prefix + ".jdbc.removeAbandoned", "true")));
        dataSource.setRemoveAbandonedTimeout(YiayoStringUtils.parseInt(properties.getProperty(prefix + ".jdbc.removeAbandonedTimeout"), 1800));
