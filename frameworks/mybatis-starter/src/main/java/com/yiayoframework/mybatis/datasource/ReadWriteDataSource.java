package com.yiayoframework.mybatis.datasource;
 ...
 * 目前实现功能
 *   一写库多读库选择功能，请参考
 *      @see com.yiayoframework.mybatis.datasource.ReadWriteDataSourceDecision
 * @see com.yiayoframework.mybatis.datasource.ReadWriteDataSourceDecision.DataSourceType
 *
 *   默认按顺序轮询使用读库
 *   默认选择写库
 *
