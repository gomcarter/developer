package com.yiayoframework.httpbaseapi.utils;

import com.yiayoframework.base.common.CookieUtils;
...
public class ApiTokenUtils {
    ...
    private static final String publicKey = "liyin";
    ...
    private static String getKey(int offset) {
        String time = YiayoDateUtils.toString(getEnCodeTime(offset));
        return getKey(time);
    }
