...
import com.yiayoframework.base.json.JsonTData;
import com.yiayoframework.base.mapper.JsonMapper;
import com.yiayoframework.httpbaseapi.auth.AuthStrategy;
import com.yiayoframework.httpbaseapi.auth.CpsApiAuthStrategy;
import com.yiayoframework.httpbaseapi.impl.DefaultHttpClientManager;
import com.yiayoframework.httpbaseapi.impl.HttpClientTemplate;
import com.yiayoframework.httpbaseapi.impl.handler.DefaultResponseHandler;
...
import com.yiayoframework.httpbaseapi.request.CpsGetRequest;
import com.yiayoframework.httpbaseapi.request.CpsPostRequest;
...
public abstract class BaseApi implements DisposableBean, InitializingBean {
    ...
    protected AuthStrategy authStrategy = new CpsApiAuthStrategy();
    ...
    public String httpExcute(Method method, String urlKey, Map<String, Object> params, List<String> restParams, String body, Map<String, String> headers, Map<String, File> files) {
        ...
        try {
            if (method == Method.GET) {
                ...
                RequestMessage message = authStrategy.init(new CpsGetRequest(urlKey).addAllParams(params).getRequestMessage());
                ...
                PostRequestMessage message = new CpsPostRequest<>(urlKey).addAllParams(params).getPostRequestMessage();
