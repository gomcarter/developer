...
import com.yiayoframework.base.json.JsonError;
import com.yiayoframework.base.json.JsonObject;
...
/**
 * @author 李银  on 2019-11-11 23:17:48
 */
//@ControllerAdvice
public class BaseController {
    ...
    public JsonObject exceptionHandler(HttpServletRequest request, Exception exception) {
        ...
        logger.error("{}操作失败, url:{}, method:{}, ip: {}, Referer: {}, UA: {}, cpsversion: {}, params: {}, cookie: {},header: {},",
