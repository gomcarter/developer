package it.gomcarter.frameworks.redis;

import it.gomcarter.frameworks.redis.aop.DataRedisInterceptor;
import it.gomcarter.frameworks.redis.tool.RedisProxy;
...
public class RedisConfiguration {
    ...
    @Pointcut("@annotation(it.gomcarter.frameworks.redis.annotation.Cache)")
    ...
    @Pointcut("@annotation(it.gomcarter.frameworks.redis.annotation.DelCache)")
    ...
    @Pointcut("@annotation(it.gomcarter.frameworks.redis.annotation.Lock)")
