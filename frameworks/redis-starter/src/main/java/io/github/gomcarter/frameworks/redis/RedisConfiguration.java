...
import io.github.gomcarter.frameworks.redis.aop.DataRedisInterceptor;
...
public class RedisConfiguration {
    ...
    @Pointcut("@annotation(io.github.gomcarter.frameworks.redis.annotation.Cache)")
    ...
    @Pointcut("@annotation(io.github.gomcarter.frameworks.redis.annotation.DelCache)")
    ...
    @Pointcut("@annotation(io.github.gomcarter.frameworks.redis.annotation.Lock)")
