...
import com.yiayoframework.redis.aop.DataRedisInterceptor;
...
public class RedisConfiguration {
    ...
    @Pointcut("@annotation(com.yiayoframework.redis.annotation.Cache)")
    ...
    @Pointcut("@annotation(com.yiayoframework.redis.annotation.DelCache)")
    ...
    @Pointcut("@annotation(com.yiayoframework.redis.annotation.Lock)")
