package com.yiayoframework.redis.aop;

import com.yiayoframework.base.exception.NonConcurrencyException;
import com.yiayoframework.redis.annotation.Cache;
import com.yiayoframework.redis.annotation.DelCache;
import com.yiayoframework.redis.annotation.Lock;
...
public class DataRedisInterceptor {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(RedisDataMapper.buildNormalMapper().toJson(""));
        System.out.println(RedisDataMapper.buildNormalMapper().toJson(1));
        System.out.println(RedisDataMapper.buildNormalMapper().toJson(1L));
        System.out.println(RedisDataMapper.buildNormalMapper().toJson("L1"));
        System.out.println(RedisDataMapper.buildNormalMapper().toJson(0.13D));
        System.out.println(RedisDataMapper.buildNormalMapper().toJson(false));
        System.out.println(RedisDataMapper.buildNormalMapper().toJson(null));
        System.out.println(RedisDataMapper.buildNormalMapper().toJson(new String[]{"2", "2"}));
        System.out.println(RedisDataMapper.buildNormalMapper().toJson(new Md5Hash("").toHex()));
    }
}
