package ${entity.paramPackageName};
 ...
 */
public class J${entity.className}QueryParams {
...
<#list entity.propList as prop>
    ...
    public J${entity.className}QueryParams ${entity.idSetMethod}(${entity.idSimpleType} ${entity.idName}) {
...
<#list entity.propList as prop>
    ...
    public J${entity.className}QueryParams ${prop.setMethod}(${prop.simpleType} ${prop.propName}) {
